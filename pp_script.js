...
function update(){
    ...
    if(collision(ball,player)){
        ...
        // Khi quả bóng chạm vào phần đầu của thanh dọc, chúng ta muốn quả bóng lấy một góc -45 độ
        // Khi quả bóng chạm vào phần giữa của của thanh dọc, chúng ta muốn quả bóng lấy một góc 0 độ
        // Khi quả bóng chạm vào đáy của thanh dọc, chúng ta muốn quả bóng lấy 1 góc 45 độ
        // Math.PI/4 = 45degrees
